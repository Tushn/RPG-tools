...
public class Combate {
    ...
    public static int luta(PersonagemJogador pj, Inimigo enemy) {
        ...
        while(true){
            ...
            if(pj.getEnergia()>0 && enemy.getEnergia()<=0){
    ...
    public static int luta(PersonagemJogador pj, Inimigo[] enemy){
        ...
        while(true){
            ...
            }while(opcao > cont || enemy[opcao].getEnergia()<0);
            // Oponentes atacados
    ...
    public static void estado(PersonagemJogador pj, Inimigo enemy){
        System.out.println("\nPj, nome: "+pj.nome+". Habilidade: "+pj.getHabilidade()+". Energia: "+pj.getEnergia()+"\nInimigos: \n");
        System.out.print(enemy.nome+" \nEnergia: "+enemy.getEnergia()+". Habilidade: "+enemy.getHabilidade());
    }
    
    // mostrar estado da batalha do jogador e dos oponentes
    public static void estado(PersonagemJogador pj, Inimigo[] enemy){
        System.out.println("\nPj, nome: "+pj.nome+". Habilidade: "+pj.getHabilidade()+". Energia: "+pj.getEnergia()+". Sorte: "+pj.getSorte()+"\nInimigos: \n");
        for(int i=0;i<enemy.length;i++)
            System.out.print(enemy[i].nome+" \nEnergia: "+enemy[i].getEnergia()+". Habilidade: "+enemy[i].getHabilidade()+"\n");
    }
