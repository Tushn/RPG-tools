...
function init()
{
	...
	*/
    ...
    /*for (var i = 0; i < 5; i++) {
        ...
        var die = new dN[i]({size: 1.5, backColor: colors[i]});
    ...
    function randomDiceThrow() {
		...
		for(var i=0; i<dice.length; i++){
			// var text = $(".dice_result").get(dFaces.indexOf(dice[i].countFaces)).textContent;
			$(".dice_result").get(dFaces.indexOf(dice[i].countFaces)).textContent += dice[i].getUpsideValue()+" ,";
			// text += dice[i].getUpsideValue()+" ,";
		}
    }
